...
if soure == 'www.facebook.com':
    ...
    data_for_dash_facebook = pd.read_csv('data_pre_settingหมอใหญท.csv', encoding='utf-8-sig')
             ...
             html.Div([
                ...
                html.Div([
                    ...
                    dcc.Checklist(id='pie-charts-Gender-names',
                        ...
                        ],style={'width': '29%', 'display': 'inline-block',"float":"right"}),
                    html.Br(style={'display':'block', 'margin-top':'10px', 'line-height':'22px'}),
                    html.Br(style={'display':'block', 'margin-top':'10px', 'line-height':'22px'}),
                    html.Br(style={'display':'block', 'margin-top':'10px', 'line-height':'22px'}),
                    ]),
                html.Div([
                ...
                html.Div([
                    ...
                    ],style={'width': '20%', 'display': 'inline-block',"height": "300px","float":"right"}),
                    html.Br(),
                    html.Br(),
                html.Div([
                ...
                html.Div([
                    ...
                    ],style={'width': '20%', 'display': 'inline-block',"height": "100px","float":"right"}),
    ...
    html.Div(
        ...
        dbc.ModalBody(
            ...
            html.Div(id="dummy"),
            ],style={'width': '1000px', 'display': 'inline-block',"height": "300px","float":"right"})
            ])
    @callback(
    ...
    def generate_chart(exp,Gender,carcer,useful,sym,count_like,count_rechat,count_word):
        ...
        return [fig_1,fig_2,fig_3,fig_4,fig_5,fig_6,fig_7,fig_8,text_1,text_2,text_3,text_4,text_5,text_6,text_7,text_8]
